...
class StorageFactory:
    ...
    def get_chat_storage(self) -> MongoDBChatStorage:
        ...
        return MongoDBChatStorage(self.mongo_uri, self.db_name, collection_name="conversations")
    ...
    def get_storage(self, storage_type: str) -> Union[MongoDBChatStorage, MongoDBTaskStorage]:
