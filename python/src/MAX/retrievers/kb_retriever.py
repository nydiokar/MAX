...
class KnowledgeBasesRetriever(Retriever):
    ...
    async def _retrieve_from_chroma(self, text: str, **kwargs) -> List[Dict[str, Any]]:
    ...
    async def _retrieve_from_mongo(self, text: str, **kwargs) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            ).sort([("score", {"$meta": "textScore"})]).limit(self.options.max_results)
    ...
    async def _retrieve_basic(self, text: str, **kwargs) -> List[Dict[str, Any]]:
